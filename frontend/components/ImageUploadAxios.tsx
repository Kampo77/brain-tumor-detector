...
/**
 * ALTERNATIVE: ImageUpload component using Axios instead of fetch
 * 
 * If you prefer Axios over native fetch, use this component instead.
 * First, install: npm install axios
 * 
 * This component has identical functionality to ImageUpload.tsx
 * but uses Axios for HTTP requests.
 */
...
export default function ImageUploadAxios({
  onAnalysisComplete,
  apiBaseUrl = 'http://127.0.0.1:8000',
}: ImageUploadAxiosProps) {
